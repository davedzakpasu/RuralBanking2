package com.cergi.ruralbanking.fingerprints.utils;

import com.cergi.ruralbanking.fingerprints.logic.BluetoothChatService;
import com.cergi.ruralbanking.fingerprints.logic.FingerprintAPI;
import com.cergi.ruralbanking.fingerprints.logic.FingerprintAPI.Result;
...
public class AsyncFingerprint extends Handler{
    ...
    private final FingerprintAPI fingerprint;
