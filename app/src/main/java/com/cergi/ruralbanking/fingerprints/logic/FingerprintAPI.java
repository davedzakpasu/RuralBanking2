package com.cergi.ruralbanking.fingerprints.logic;

import java.io.ByteArrayOutputStream;
import java.io.DataOutputStream;

import com.cergi.ruralbanking.fingerprints.utils.DataUtils;
...
public class FingerprintAPI {
    ...
    /**
     * ������:��λ���������ݴ�ŵ� Buffer: The next crew to return data storage
     * places
     */
    private final byte[] data = new byte[1024 * 50];

    private final byte[] buffer = new byte[1024 * 50];

    private final byte[] bufferImage = new byte[1024 * 50];
    ...
    /**
     * ȷ���룺0x20��0xefΪ������ȷ���� ��ʾָ��ִ����ϻ�OK�� 0x20��0xefThe for the
     * Reserved Indicates instruction completes or OK
     */
    ...
    /**
     * ��ʾָ��ͼ��̫�ɡ�̫���������������� Represents the fingerprint image is too
     * dry, not too light and health characteristics;
     */
    public static final int FINGERPRINT_SMALL = 0x04;
    /**
     * ��ʾָ��ͼ��̫ʪ��̫���������������� Represents the fingerprint image is too
     * wet, not too paste feature is born;
     */
    ...
    /**
     * ��ʾָ��ͼ����������������̫�٣������̫С���������������� Represents the
     * fingerprint image is normal, but too few feature points (or too small)
     * was born not characteristic;
     */
    ...
    /**
     * ��ʾ��ָ�ƿ��ģ��������Ч�� Represents a template from a fingerprint database
    ...
    /**
     * ¼��ָ��ͼ�� ����˵���� ̽����ָ��̽�⵽��¼��ָ��ͼ�����ImageBuffer��
     * ����ȷ�����ʾ��¼��ɹ�������ָ�ȡ�
     *
     * @return ����ֵΪȷ���� ȷ����=00H��ʾ¼��ɹ� ȷ����=01H��ʾ�հ��д�
     * ȷ����=02H��ʾ������������ָ ȷ����=03H��ʾ¼�벻�ɹ� ȷ����=ffH ��ʾ����Ӧ Input
     * fingerprint image Function: probing fingers, detected after the entry
     * stored in the fingerprint image ImageBuffer. Return Confirmation code
     * said: Entry Success, no fingers.
     * @return Confirmation code Confirmation code=00H Indicates successful
     * entry Confirmation code=01H An indication that the package is wrong
     * Confirmation code=02H Indicates that the sensor is no finger Confirmation
     * code=03H Indicates unsuccessful entry Confirmation code=ffH Indicates no
     * response
     */
    ...
    /**
     * ����˵���� ��ImageBuffer �е�ԭʼͼ������ָ�������ļ�����CharBuffer1
     * ��CharBuffer2 ��������� BufferID(������������)
     *
     * @param bufferId ��CharBuffer1:1h,CharBuffer2:2h��
     * @return ����ֵΪȷ���� ȷ����=00H��ʾ���������ɹ� ȷ����=01H��ʾ�հ��д�
     * ȷ����=06H��ʾָ��ͼ��̫�Ҷ�����������
     * ȷ����=07H��ʾָ��ͼ����������������̫�ٶ�����������
     * ȷ����=15H��ʾͼ�񻺳�����û����Чԭʼͼ��������ͼ�� ȷ����=ffH��ʾ����Ӧ Function
     * Description: ImageBuffer the original image to generate the fingerprint
     * profiles stored in CharBuffer1 or CharBuffer2 Input parameters: BufferID
     * (characteristic buffer number)
     * @param bufferId ��CharBuffer1:1h,CharBuffer2:2h��
     * @return Confirmation code Confirmation code=00H Indicates successful
     * generation features Confirmation code=01H An indication that the package
     * is wrong Confirmation code=06H Indicates born fingerprint image is too
     * chaotic fragmentation characteristics Confirmation code=07H Represents
     * the fingerprint image is normal, but too few feature points fragmentation
     * characteristics and health Confirmation code=15H Means that there is no
     * valid image buffer born fragmentation original image image Confirmation
     ...
     *
     * @return ����ֵΪȷ���� ȷ����=00H��ʾ�ϲ��ɹ� ȷ����=01H��ʾ�հ��д�
     * ȷ����=0aH��ʾ�ϲ�ʧ�ܣ���öָ�Ʋ�����ͬһ��ָ�� ȷ����=ffH ��ʾ����Ӧ Merge features
     * generate a template that will CharBuffer1 and CharBuffer2 features in the
     * file merge generation templates The result is stored in CharBuffer1 and
     * CharBuffer2 in.
     *
     * @return Confirmation code Confirmation code=00H Means that the merge was
     * successful Confirmation code=01H An indication that the package is wrong
     * Confirmation code=0aH Expressed merge failure (two fingerprints do not
     * belong to the same finger) Confirmation code=ffH Indicates no response
     */
     ...
     *
     * @return ����ֵΪȷ���� ȷ����=00H��ʾ����ɹ� ȷ����=01H��ʾ�հ��д�
     * ȷ����=0bH��ʾPageID����ָ�ƿⷶΧ ȷ����=18H��ʾдFLASH���� ȷ����=ffH ��ʾ����Ӧ The
     * CharBuffer templates stored to the specified number of flash pageId
     * database location bufferId: can only 1h or 2h pageId��0~1010 Input
     * parameters: BufferID (buffer number), PageID (fingerprint location
     * number)
     * @return Confirmation code Confirmation code=00H Expressed successfully
     * saved Confirmation code=01H An indication that the package is wrong
     * Confirmation code=0bH PageID beyond the scope of representation
     * fingerprint database Confirmation code=18H FLASH write error indicates
     ...
     * @param index pageId��
     * @return ����ֵΪȷ���� ȷ����=00H��ʾ�����ɹ� ȷ����=01H��ʾ�հ��д�
     * ȷ����=0cH��ʾ�����д��ģ���д� ȷ����=0BH��ʾPageID����ָ�ƿⷶΧ ȷ����=ffH ��ʾ����Ӧ
     * Specified in the database will flash fingerprint template pageId number
     * read into the stencil buffer CharBuffer1 or CharBuffer2 bufferId:1h or 2h
     ...
     * Confirmation code=0cH Is the readout wrong or wrong template Confirmation
     * code=0BH PageID beyond the scope of representation fingerprint database
     * Confirmation code=ffH Indicates no response
     */
     ...
     * ��������� BufferID�� StartPage(��ʼҳ)��PageNum��ҳ���� ���ز�����
     * ȷ���֣�ҳ�루����ָ��ģ�壩
     *
     * @param bufferId ������1h��2h
     * @param startPageId ��ʼҳ
     * @param pageNum ҳ��
     * @return ȷ����=00H ��ʾ�������� ȷ����=01H ��ʾ�հ��д� ȷ����=09H
     * ��ʾû����������ʱҳ����÷�Ϊ0 ȷ����=ffH ��ʾ����Ӧ In CharBuffer1 or CharBuffer2
     * the feature to search the entire or part of the file fingerprint
     * database. If found, it returns the page number. Input parameters:
     * BufferID, StartPage (Home), PageNum (Pages) Return parameter: confirm the
     * word, page (match fingerprint templates)
     * @param bufferId buffer:1h��2h
     * @param startPageId
     * @param pageNum
     * @return Confirmation code=00H Indicates that the search to; Confirmation
     * code=01H An indication that the package is wrong�� Confirmation code=09H
     * Said they were not searched; this time with a score of 0 page
     * Confirmation code=ffH Indicates no response
     */
     ...
     * ע���:��λ�����ص��������滹��һ���÷֣����÷ִ��ڵ���50ʱ��ָ��ƥ��
     *
     * @return true��ָ��ƥ��ɹ� false���ȶ�ʧ�� Exact Match CharBuffer1 the
     * signature file with CharBuffer2 attention point: the next crew returned
     * data there is also a score when the score is greater than or equal to 50,
    ...
    /**
     * �ɼ�һ��ָ��ע��ģ�壬��ָ�ƿ���������λ���洢�����ش洢pageId ���ز�����
     * ȷ���֣�ҳ�루����ָ��ģ�壩
     *
     * @return ȷ����=00H ��ʾע��ɹ��� ȷ����=01H ��ʾ�հ��д� ȷ����=1eH ��ʾע��ʧ�ܡ�
     * ȷ����=ffH ��ʾ����Ӧ Collect a fingerprint registration template,
     * fingerprint database search space and storage, Storeback pageId Return
     * parameter: confirm the word, page (match fingerprint templates)
     * @return Confirmation code=00H Indicates successful registration;
     * Confirmation code=01H An indication that the package is wrong��
     * Confirmation code=1eH Means that the registration failed. Confirmation
     * code=ffH Indicates no response
     */
     ...
     *
     * @return ȷ����=00H ��ʾ�������� ȷ����=01H ��ʾ�հ��д� ȷ����=09H
     * ��ʾû����������ʱҳ����÷�Ϊ0 ȷ����=ffH ��ʾ����Ӧ Automatic fingerprint in the
     * fingerprint database search target template and return to search results.
     * If the target template with the current collection of fingerprint
     * matching score greater than the highest threshold, And the target
     * template is incomplete collection characteristic feature places a blank
     * area to update the target template. Return parameters: Confirmation code,
     * page number (matching fingerprint template)
     * @return Confirmation code=00H Indicates that the search to; Confirmation
     * code=01H An indication that the package is wrong�� Confirmation code=09H
     * Said they were not searched; this time with a score of 0 page
     * Confirmation code=ffH Indicates no response
    ...
    /**
     * ɾ��ģ�� ɾ��flash ���ݿ���ָ��ID �ſ�ʼ��N ��ָ��ģ��
     * ���������PageID(ָ�ƿ�ģ���)��N ɾ����ģ�������
     *
     * @param pageIDStart
     * @param delNum
     * @return ȷ����=00H ��ʾɾ��ģ��ɹ��� ȷ����=01H ��ʾ�հ��д� ȷ����=10H
     * ��ʾɾ��ģ��ʧ�ܣ� ȷ����=ffH ��ʾ����Ӧ Delete Template Delete a flash ID number
     * specified in the database Start the N fingerprint templates Input
     * parameters: PageID (fingerprint database template number), N the number
     * of the deleted template.
     * @param pageIDStart
     * @param delNum
     * @return Confirmation code=00H Success means to delete the template;
     * Confirmation code=01H An indication that the package is wrong��
     * Confirmation code=10H Means to delete the template failed; Confirmation
     * code=ffH Indicates no response
     */
     ...
     * ����˵���� ɾ��flash ���ݿ�������ָ��ģ��
     *
     * @return ȷ����=00H ��ʾ��ճɹ��� ȷ����=01H ��ʾ�հ��д� ȷ����=11H ��ʾ���ʧ�ܣ�
     * ȷ����=ffH ��ʾ����Ӧ Function: Delete all fingerprint template flash
     * database
     * @return Confirmation code=00H Empty successful representation;
     * Confirmation code=01H An indication that the package is wrong��
     * Confirmation code=11H Represents clear failure; Confirmation code=ffH
     ...
     *
     * @return byte[]������Ϊ512�ֽڳɹ� ����ʧ�� null:�ϴ������ļ�ʧ�� The
     * characteristic features of the buffer file uploads to the host computer
     * (the default feature buffer charbuffer1)
     *
     ...
     *
     * @param model :ָ�Ƶ������ļ�
     * @return ����ֵΪȷ���� ȷ����=00H ��ʾ���Խ��պ������ݰ��� ȷ����=01H ��ʾ�հ��д�
     * ȷ����=0eH ��ʾ���ܽ��պ������ݰ��� ȷ����=ffH ��ʾ����Ӧ download the signature
     * file to the module characteristics buffer (the default buffer
     * CharBuffer2)
     *
     * @param model :Fingerprint template
     * @return Confirmation code Confirmation code=00H Means that subsequent
     * packets can be received; Confirmation code=01H An indication that the
     * package is wrong�� Confirmation code=0eH That they can not receive
     * subsequent data packets; Confirmation code=ffH Indicates no response
     */
     ...
     * ��ͼ�񻺳����������ϴ�����λ��
     *
     * @return ����ֵΪbmp��ʽ��ָ��ͼ�����Ϊnull�ϴ�ʧ�� Upload the image buffer data
